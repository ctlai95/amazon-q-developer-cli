...
export function activate(context: vscode.ExtensionContext) {
  ...
  function selectionsEqual(sel1: vscode.Selection, sel2: vscode.Selection): boolean {
  ...
  function checkSelectionStability() {
    ...
    if (timeSinceLastChange >= 300 && lastSelection) {
      ...
      const isDifferentFromLast = !lastSentSelection || 
  ...
  let documentClickDisposable = vscode.commands.registerCommand('editor.action.mouseCommand', () => {
  ...
  let keyReleaseDisposable = vscode.workspace.onDidChangeTextDocument((event) => {
